...
#ifndef LV_ATTRIBUTE_IMG_MENüART2
#define LV_ATTRIBUTE_IMG_MENüART2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART2 uint8_t MenüArt2_map[] = {
