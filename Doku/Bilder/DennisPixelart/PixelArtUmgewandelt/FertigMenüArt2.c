...
#ifndef LV_ATTRIBUTE_IMG_FERTIGMENüART2
#define LV_ATTRIBUTE_IMG_FERTIGMENüART2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_FERTIGMENüART2 uint8_t FertigMenüArt2_map[] = {
...
const lv_img_dsc_t FertigMenüArt2 = {
  .header.always_zero = 0,
  .header.w = 128,
  .header.h = 64,
  .data_size = 1032,
  .header.cf = LV_IMG_CF_INDEXED_1BIT,
  .data = FertigMenüArt2_map,
};
