...
#ifndef LV_ATTRIBUTE_IMG_MENüART5
#define LV_ATTRIBUTE_IMG_MENüART5
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART5 uint8_t MenüArt5_map[] = {
