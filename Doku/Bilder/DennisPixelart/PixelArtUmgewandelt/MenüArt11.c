...
#ifndef LV_ATTRIBUTE_IMG_MENüART11
#define LV_ATTRIBUTE_IMG_MENüART11
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART11 uint8_t MenüArt11_map[] = {
