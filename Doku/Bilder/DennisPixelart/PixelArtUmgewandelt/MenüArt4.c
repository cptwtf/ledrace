...
#ifndef LV_ATTRIBUTE_IMG_MENüART4
#define LV_ATTRIBUTE_IMG_MENüART4
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART4 uint8_t MenüArt4_map[] = {
