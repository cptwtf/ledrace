...
#ifndef LV_ATTRIBUTE_IMG_INFOART2
#define LV_ATTRIBUTE_IMG_INFOART2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_INFOART2 uint8_t InfoArt2_map[] = {
