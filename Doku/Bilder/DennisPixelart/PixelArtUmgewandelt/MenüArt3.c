...
#ifndef LV_ATTRIBUTE_IMG_MENüART3
#define LV_ATTRIBUTE_IMG_MENüART3
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART3 uint8_t MenüArt3_map[] = {
