...
#ifndef LV_ATTRIBUTE_IMG_MENüART7
#define LV_ATTRIBUTE_IMG_MENüART7
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_MENüART7 uint8_t MenüArt7_map[] = {
