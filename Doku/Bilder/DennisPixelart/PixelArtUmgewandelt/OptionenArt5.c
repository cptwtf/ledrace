...
#ifndef LV_ATTRIBUTE_IMG_OPTIONENART5
#define LV_ATTRIBUTE_IMG_OPTIONENART5
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_OPTIONENART5 uint8_t OptionenArt5_map[] = {
...
const lv_img_dsc_t OptionenArt5 = {
  .header.always_zero = 0,
  .header.w = 128,
  .header.h = 64,
  .data_size = 1032,
  .header.cf = LV_IMG_CF_INDEXED_1BIT,
  .data = OptionenArt5_map,
};
